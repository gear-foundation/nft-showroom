...
export class NftShowroom {
  ...
  public async all(
    ...
    const payload = this._program.registry
      .createType('(String, String)', ['NftShowroom', 'All'])
      .toHex();
  ...
  public async getAdmins(
    ...
    const payload = this._program.registry
      .createType('(String, String)', ['NftShowroom', 'GetAdmins'])
      .toHex();
    const reply = await this._program.api.message.calculateReply({
      destination: this._program.programId,
      origin: originAddress ? decodeAddress(originAddress) : ZERO_ADDRESS,
  ...
  public async getAllCollections(
    ...
    const payload = this._program.registry
      .createType('(String, String)', ['NftShowroom', 'GetAllCollections'])
      .toHex();
    const reply = await this._program.api.message.calculateReply({
      destination: this._program.programId,
      origin: originAddress ? decodeAddress(originAddress) : ZERO_ADDRESS,
  ...
  public async getAllowMessage(
    ...
    const payload = this._program.registry
      .createType('(String, String)', ['NftShowroom', 'GetAllowMessage'])
      .toHex();
    const reply = await this._program.api.message.calculateReply({
      destination: this._program.programId,
      origin: originAddress ? decodeAddress(originAddress) : ZERO_ADDRESS,
  ...
  public async getCollectionInfo(
    ...
    const result = this._program.registry.createType(
      '(String, String, Option<CollectionInfo>)',
      reply.payload,
    );
  ...
  public async getConfig(
    ...
    const payload = this._program.registry
      .createType('(String, String)', ['NftShowroom', 'GetConfig'])
      .toHex();
    const reply = await this._program.api.message.calculateReply({
      destination: this._program.programId,
      origin: originAddress ? decodeAddress(originAddress) : ZERO_ADDRESS,
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          ...
          getFnNamePrefix(payload) === 'Initialized'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToNewCollectionAddedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'NewCollectionAdded'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToCollectionCreatedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'CollectionCreated'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"type_name":"String","collection_address":"[u8;32]"})',
                message.payload,
              )[2]
              .toJSON() as unknown as {
              type_name: string;
      ...
      ({ data: { message } }) => {
        ...
        if (
          ...
          callback(
            this._program.registry
              .createType(
                '(String, String, {"collection_address":"[u8;32]","minter":"[u8;32]"})',
                message.payload,
              )[2]
              .toJSON() as unknown as {
              collection_address: ActorId;
  ...
  public subscribeToSaleNftEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'SaleNft'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToSaleNftCanceledEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'SaleNftCanceled'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"collection_address":"[u8;32]","token_id":"u64"})',
                message.payload,
              )[2]
              .toJSON() as unknown as {
              collection_address: ActorId;
  ...
  public subscribeToNftSoldEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'NftSold'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToAuctionCreatedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'AuctionCreated'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToAuctionClosedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'AuctionClosed'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToBidAddedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'BidAdded'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToAuctionCanceledEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'AuctionCanceled'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToOfferCreatedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'OfferCreated'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToOfferCanceledEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'OfferCanceled'
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToOfferAcceptedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'OfferAccepted'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"offer":"Offer"})',
                message.payload,
              )[2]
  ...
  public subscribeToCollectionDeletedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'CollectionDeleted'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"collection_address":"[u8;32]"})',
                message.payload,
              )[2]
  ...
  public subscribeToAdminsAddedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'AdminsAdded'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"users":"Vec<[u8;32]>"})',
                message.payload,
              )[2]
  ...
  public subscribeToAdminDeletedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'AdminDeleted'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"user":"[u8;32]"})',
                message.payload,
              )[2]
  ...
  public subscribeToBalanceHasBeenWithdrawnEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'BalanceHasBeenWithdrawn'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"value":"u128"})',
                message.payload,
              )[2]
  ...
  public subscribeToValueSentEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'ValueSent'
        ) {
          callback(null);
        }
      },
  ...
  public subscribeToAllowMessageChangedEvent(
    callback: (data: null) => void | Promise<void>,
  ): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent(
      'UserMessageSent',
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'AllowMessageChanged'
        ) {
          callback(null);
        }
      },
  ...
  public subscribeToCollectionTypeDeletedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === 'NftShowroom' &&
          getFnNamePrefix(payload) === 'CollectionTypeDeleted'
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"type_name":"String"})',
                message.payload,
              )[2]
