...
export type NftQueryQuery = { __typename?: 'Query', nftById?: { __typename?: 'Nft', idInCollection: number, mediaUrl: string, id: string, owner: string, createdAt: any, name: string, description: string, collection: { __typename?: 'Collection', royalty?: number | null, name?: string | null, sellable?: boolean | null, transferable?: boolean | null } } | null };
