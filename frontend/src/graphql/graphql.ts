...
export type CollectionSubSubscriptionVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type CollectionSubSubscription = { __typename?: 'Subscription', collectionById: { __typename?: 'Collection', id: string, name: string, description: string, collectionBanner: string, collectionLogo: string, admin: string, tokensLimit: string | null, permissionToMint: Array<string> | null, userMintLimit: string | null, paymentForMint: string, transferable: string | null, sellable: string | null, additionalLinks: { __typename?: 'AdditionalLinks', discord: string | null, externalUrl: string | null, medium: string | null, xcom: string | null, telegram: string | null } | null } | null };
...
export type CollectionsNfTsCountQueryQuery = { __typename?: 'Query', nftsInCollection: Array<{ __typename?: 'NftsInCollection', collection: string, count: string }> };
